  ...
  template: `
    <div class="max-w-5xl mx-auto px-4 py-6">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <!-- Liste des items (style compact pour le profil) -->
        <section class="xl:col-span-2 space-y-3">
          ...
          <div class="bg-white rounded-lg border p-3 flex items-center gap-3">
            <img [src]="it.imageUrl" [alt]="it.title" class="w-20 h-20 object-cover rounded-md" />

            <div class="flex-1 min-w-0">
              <div class="flex items-start justify-between gap-3">
                <div class="min-w-0">
                  <div class="font-semibold text-gray-900 truncate">{{ it.title }}</div>
                  <div class="text-xs text-gray-500 truncate" *ngIf="it.artistName">
                    {{ it.artistName }}
                  </div>
                  <div class="text-xs text-gray-600 mt-0.5" *ngIf="it.variantLabel">
                    {{ it.variantLabel }}
                  </div>
                </div>
                ...
                <button
                  ...
                  class="text-xs text-red-600 hover:text-red-700 flex-shrink-0"
              ...
              <div class="mt-2 flex items-center justify-between">
                <div class="inline-flex items-center rounded-full border border-gray-300 bg-white">
                  <button
                    type="button"
                    class="px-3 py-1.5 text-gray-700 hover:bg-gray-50 rounded-l-full"
                  ...
                  <span class="px-3 font-semibold tabular-nums select-none">{{ it.qty }}</span>
                  <button
                    type="button"
                    class="px-3 py-1.5 text-gray-700 hover:bg-gray-50 rounded-r-full"
                ...
                <div class="text-right">
                  <div class="text-gray-900 font-semibold">{{ it.unitPrice * it.qty | price }}</div>
        ...
        <!-- Récap -->
        <aside class="bg-white rounded-lg border p-5 h-fit">
          <h2 class="font-semibold text-gray-900 mb-3">Résumé</h2>
          ...
          <a
            class="mt-4 w-full inline-flex items-center justify-center px-4 py-2 rounded-md bg-blue-600 text-white hover:bg-blue-700"
          ...
          <button
            type="button"
            class="mt-2 w-full inline-flex items-center justify-center px-4 py-2 rounded-md bg-gray-100 text-gray-800 hover:bg-gray-200"
            (click)="onClearCart()"
          >
            Vider le panier
          </button>
          ...
          <a
            routerLink="/catalog"
            class="mt-2 w-full inline-flex items-center justify-center px-4 py-2 rounded-md bg-white border hover:bg-gray-50"
          >

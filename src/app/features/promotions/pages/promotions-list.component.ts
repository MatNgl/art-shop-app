      ...
      @else if (filteredPromotions().length === 0) {
        <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
          ...
          <p class="text-gray-600 mb-4">
            @if (filterStatus() !== 'all') {
              Aucune promotion {{ filterStatus() === 'active' ? 'active' : 'inactive' }} trouvée.
            } @else {
              ...
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  ...
                  <div class="flex items-center gap-3 mb-2">
                    ...
                    <!-- Badges -->
                    <span
                      [class]="promotion.isActive ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'"
                    ...
                    @if (promotion.code) {
                      <span class="px-2 py-1 text-xs font-mono font-bold bg-indigo-100 text-indigo-800 rounded">
                        {{ promotion.code }}
                      </span>
                    }
                  </div>
                  ...
                  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span class="ml-2 font-medium text-gray-900">{{ getScopeLabel(promotion.scope) }}</span>
                    </div>
                  ...
                  @if (promotion.conditions) {
                    <div class="mt-3 flex flex-wrap gap-2 text-xs">
                      ...
                      @if (promotion.conditions.maxUsageTotal) {
                        <span class="px-2 py-1 bg-purple-50 text-purple-700 rounded">
                          {{ promotion.currentUsage ?? 0 }}/{{ promotion.conditions.maxUsageTotal }} utilisations
                        </span>
                      }
                    </div>
                  }
                ...
                <div class="flex items-center gap-2 ml-4">
                  ...
                  >
                    <i
                      [class]="promotion.isActive ? 'fa-solid fa-toggle-on text-green-600' : 'fa-solid fa-toggle-off text-gray-400'"
                      class="text-xl"
                    ></i>
                  </button>

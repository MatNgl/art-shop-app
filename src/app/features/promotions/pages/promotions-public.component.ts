    ...
    <div class="min-h-screen bg-gray-50">
      ...
      <div class="container-wide py-8">
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-12 text-center">
          ...
          <p class="text-gray-600 mb-4">Revenez bientôt pour découvrir nos nouvelles offres !</p>
          <a
            routerLink="/catalog"
          ...
          >
            ...
            <div class="flex items-start justify-between mb-4">
              ...
              <div class="ml-4 flex-shrink-0">
                <div
                  class="bg-gradient-to-br from-orange-500 to-red-500 text-white px-4 py-2 rounded-lg text-center"
                >
                  <div class="text-2xl font-bold">
                    @if (promo.discountType === 'percentage') { -{{ promo.discountValue }}% } @else
                    { -{{ promo.discountValue }}€ }
                  </div>
            ...
            >
              @if (promo.scope === 'site-wide') { Voir le catalogue } @else if (promo.scope ===
              'category' || promo.scope === 'subcategory') { Voir les produits } @else { Découvrir
              les produits }
            </button>
          </div>
          }
        ...
        <div class="mt-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div
              class="bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-200 rounded-lg p-6"
            >
              <div class="text-center mb-4">
                <div
                  class="inline-block px-4 py-2 bg-white border-2 border-dashed border-purple-400 rounded-lg"
                >
              ...
              <div class="text-center text-sm text-gray-600">
                ...
                @else { <strong class="text-purple-700">{{ promo.discountValue }}€</strong> de
                réduction }
              </div>
...
export class PromotionsPublicComponent implements OnInit {
  ...
  shopPromotion(promo: Promotion): void {
    ...
    if (promo.scope === 'category' && promo.categorySlugs && promo.categorySlugs.length > 0) {
      ...
      promo.scope === 'subcategory' &&
      promo.subCategorySlugs &&
      promo.subCategorySlugs.length > 0
    ) {

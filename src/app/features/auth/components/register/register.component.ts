...
@Component({
  ...
  template: `
    ...
    <!-- Contenu -->
    <div class="auth-shell w-full mx-auto max-w-6xl px-4 sm:px-6 py-6 md:py-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <!-- Vitrine -->
        <section class="hidden lg:block">
          <!-- Clip du glow au niveau wrapper (pas sur la carte) -->
          <div class="relative rounded-3xl overflow-hidden">
            <div class="absolute -inset-4 rounded-3xl bg-black/30 blur-2xl"></div>
            <div
              class="relative backdrop-blur-md bg-white/10 border border-white/25 rounded-3xl p-10
        ...
        <section class="relative w-full">
          <!-- Clip du glow au niveau wrapper -->
          <div class="relative rounded-3xl overflow-hidden">
            <div class="absolute -inset-4 rounded-3xl bg-black/35 md:bg-black/30 blur-2xl"></div>
